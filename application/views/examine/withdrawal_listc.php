    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
				...
				<a href="#">
					<button onclick="xadmin.open('添加','<?= RUN . '/users/users_add3' ?>',900,500)" class="layui-btn layui-card-header" style="float: right;margin-top: -40px;margin-right: 130px;"><i class="layui-icon"></i>添加处理
					</button>
				</a>
				<a href="#">
									...
									<td class="td-manage">
										<?php if ($once['status']==1){ ?>
											...
											<button class="layui-btn layui-btn-danger"
													onclick="xadmin.open('装箱报告生成','#‘,900,250)">
												<i class="layui-icon">&#xe642;</i>生成报告
											</button>
										<?php } ?>
									</td>
								</tr>
